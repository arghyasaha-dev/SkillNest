...
// bids
router.get("/:id/bids/new", async (req, res) => {
    const taskid = req.params.id;
...
router.get("/:id/bids/:bidid", async (req, res) => {
    const taskid = req.params.id;
...
router.get("/:id/reviews/new", async (req, res) => {
    const taskid = req.params.id;
    const task = await Task.findById(taskid);
